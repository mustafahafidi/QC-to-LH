...
prop_83 xs ys zs
  = prove ((zip (xs ++ ys) zs  :=:  (zip xs (take (length xs) zs) ++ zip ys (drop (length xs) zs)))) 
{-======================================================
                        prop_84
=======================================================-}
prop_84 :: [NAT] -> [NAT] -> [NAT] -> Prop
prop_84 xs ys zs
  = prove ((zip xs (ys ++ zs)  :=:  (zip (take (length ys) xs) ys ++ zip (drop (length ys) xs) zs))) 
{-======================================================
                   prop_85 
=======================================================-}
prop_85 :: [NAT] -> [NAT] -> Prop
prop_85 xs ys
  = given (length xs :=: length ys) $  prove (zip (rev xs) (rev ys)  :=:  rev (zip xs ys))
{-======================================================
                     prop_86 
=======================================================-}
prop_86 x y xs
